...
// Text positioning
if ($dimensions[0] <=90) { $fontsize   = 12; } else { $fontsize   = 15; }
$font = 'handlee-regular.ttf';
$bounding_box_size = imagettfbbox($fontsize, 0, $font, $text);
$text_width = $bounding_box_size[2] - $bounding_box_size[0];
$vasat = ceil(($dimensions[0] - $text_width) / 2);
...
$ypos       = (imagesy($image) / 2) - $fontheight;*/
// Generate text
...
// Add the text
imagettftext($image, $fontsize , 0, $vasat, (($dimensions[1] / 2) + 5), $setfg, $font, $text);
