...
function register_theme_assets() {
	...
	// Add Css and Js
	wp_enqueue_style( 'app', get_template_directory_uri() . '/dist/css/app.min.css', 'style' );
	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/dist/js/bootstrap.min.js', array( 'jquery' ), '1.0.0', false );
